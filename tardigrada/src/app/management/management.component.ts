...
export class ManagementComponent implements OnInit {
  ...
  rows: IManager[][] = [
    [
      ...
      {name:'Людмила Андреева',title:'правая рука директора',about:`
      Мне 34 года, за это время я успела закончить географический факультет СПбГУ с красным дипломом магистра, 4 года руководить настоящей биологической школой, побывать более чем в 30 экспедициях (часть из которых я самолично организовала), и много чего еще, что здесь не поместится, так как меня попросили ограничится одним абзацем.
      `,photo:'assets/uploads/Lucia.jpg',background:'#22504e',isLong: false},
    ],
    [
